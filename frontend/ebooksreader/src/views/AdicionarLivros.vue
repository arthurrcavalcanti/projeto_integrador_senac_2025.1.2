...
<template>
  <header>
    ...
    <p>Não sabe o ISBN do livro procure em <a href="https://openlibrary.org/" target="_blank">https://openlibrary.org/</a></p>
  </header>
  <main>
    <form v-on:submit.prevent="adicionarLivro" class="adding-form">
      <!-- icone da fontawesome -->
      <label for="isbn">Código ISBN <i class="fa fa-info-circle" title="Pesquisa automaticamente na api da openlibrary"></i></label>
